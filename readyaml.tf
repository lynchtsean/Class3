...
resource "azurerm_service_plan" "batcha06sp" {
  ...
  resource_group_name = azurerm_resource_group.azureresourcegroup.lynchterraform.name
  location            = azurerm_resource_group.azureresourcegroup.canadacentral.location
